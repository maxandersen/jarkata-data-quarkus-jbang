...
//Q:CONFIG quarkus.datasource.jdbc.url=jdbc:h2:file:./library;DB_CLOSE_DELAY=-1

//Q:CONFIG quarkus.hibernate-orm.database.generation=drop-and-create
//Q:CONFIG quarkus.hibernate-orm.sql-load-script=import.sql
...
public class Main implements Runnable {
    ...
    public void run() {
       ...
       library.booksByTitle("%us%").forEach(System.out::println);
    }
